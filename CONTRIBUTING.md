...
1. Make an [Issue](https://github.com/sensengames/unity-sensen-toolkit/issues/new)
...
```json
    {
        "dependencies": {
            "com.sensengames.unity-sensen-toolkit": "https://github.com/YOUR_USER/unity-sensen-toolkit.git"
        }
    }
```
